...
puts "Reading DEF file: $env(RESULTS_DIR)/$env(DEF_VERSION)_$env(DESIGN_DIMENSION)_upper_in.gp.def"
read_def $env(RESULTS_DIR)/$env(DEF_VERSION)_$env(DESIGN_DIMENSION)_upper_in.gp.def
...
write_def $env(RESULTS_DIR)/$env(DEF_VERSION)_$env(DESIGN_DIMENSION)_upper_out.gp.def
